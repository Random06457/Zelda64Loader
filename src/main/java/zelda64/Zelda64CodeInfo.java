...
public class Zelda64CodeInfo {
    ...
    public Zelda64CodeInfo(long codeDst, long codeVrom, long actorOvlTable, long gameStateOvlTable,
            long effectSS2OvlTable, long kaleidoMgrOvlTable, long mapMarkDataOvlInfo, long fbDemoOvlTable) {
        this.mCodeDst = codeDst;
        this.mCodeVrom = codeVrom;
        this.mActorOvlTable = actorOvlTable;
        this.mGameStateOvlTable = gameStateOvlTable;
        this.mEffectSS2OvlTable = effectSS2OvlTable;
        this.mKaleidoMgrOvlTable = kaleidoMgrOvlTable;
        this.mMapMarkDataOvlInfo = mapMarkDataOvlInfo;
        this.mFbDemoOvlTable = fbDemoOvlTable;
    }
    ...
    public static final Map<Zelda64Version, Zelda64CodeInfo> TABLE = new HashMap<Zelda64Version, Zelda64CodeInfo>() {
        {
            ...
            put(Zelda64Version.OotJapanGCMq, new Zelda64CodeInfo(0x80010ee0, 0xa86000, 0x800e7a20, 0x800f0830,
                    0x800e7130, 0x800fd980, 0x800f10e8, -1));
